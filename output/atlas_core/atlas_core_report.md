...
- Success: `True`
- Run ID: `d60b8844-d6e4-4517-8e56-0d81dda7cea0`
- Mode: `paper`
- Nodes executed: `29`
...
- `mark_to_market` success=`True` output=`mark_to_market`
...
- `investment_intelligence` success=`True` output=`investment_intelligence`
